...
<div class="wrapper">
  ...
  <nav class="navbar navbar-expand navbar-black navbar-dark">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="" class="nav-link">GALLERYWeb</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a  data-toggle="modal" data-target="#modalupload" href="#" class="nav-link btn btn-primary">Upload <i class="fa fa-upload"></i></a>
      </li>
    </ul>
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a data-toggle="modal" data-target="#modallogout" href="#" class="nav-link btn btn-warning">Logout <i class="fas fa-sign-out-alt fa-sm fa-fw"></i></a>
      </li>
      </li>
    </ul>
  </nav>
          ...
          <div class="col-md-12">
            ...
            <div class="timeline">
              ...
              <div class="time-label">
                <span class="bg-red" name = "tanggal">{{$galeri->tanggal}}</span>
              </div>
              <!-- /.timeline-label -->
              <!-- timeline item -->
              <div>
                ...
                <div class="timeline-item">
                  ...
                  <h3 class="timeline-header"><a href="#">{{$galeri->judul}}</h3>

                  <div class="timeline-body">
                    <img class="img-fluid" width="400" height="400" src="{{asset('gambar/'.$galeri->foto)}}" alt="foto"><br>
                    {{$galeri->deskripsi}}
                  </div>
                  <div class="timeline-footer">
                    <a href="" data-toggle="modal" data-target="#modaledit{{$galeri->id}}" class="btn btn-warning btn-sm">Edit</a>
                    <a href="" data-toggle="modal" data-target="#modalhapus{{$galeri->id}}" class="btn btn-danger btn-sm">Delete</a>
                  </div>
                </div>
              </div>
              <!-- END timeline item -->
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <a href="{{url('galeri/'.$galeri->id)}}" class="btn btn-danger">Hapus</a>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <img src="{{asset('gambar/'.$galeri->foto)}}" alt="foto" width="150" height="150">
                        </div>
                    </div>
                    <div class="modal-footer">
  ...
  <div class="modal fade" id="modalupload" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title">Update Foto</h3>
            </div>
